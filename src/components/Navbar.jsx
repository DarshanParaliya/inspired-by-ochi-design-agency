...
function Navbar() {
  return (
    <div className='fixed bg-transparent bg-black/500 backdrop-blur-md top-0 left-0 w-full z-50 px-20 py-8 font-["Neue Montreal"] flex justify-between items-center bg-transperent'>
     <div className='logo'>
